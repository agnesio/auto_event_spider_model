...
#input xpath
evtname = '//div[@class="pnlh1"]//h1'
evtdesc = '//p[@class="ellipsis-full"]'
...
tags = '//following::h4[text()="Category"]//following-sibling::div[@class="hours"]'
dateAndTime = '(//following::h4[text()="Schedule"]//following-sibling::div[@class="hours"])[1]//text()'
location = '//div[@class="rating"][1]//address//br[2]/preceding-sibling::text()'
